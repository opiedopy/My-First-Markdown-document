# My First Biology Markdown Note

Hello! This is a simple example file written in **Markdown**.  
It looks plain in a text editor, but becomes nicely formatted when previewed.

## Why I Like Biology
- Cells are amazing little factories
...
> "The more I study biology, the more I am convinced that life is chemistry and chemistry is physics."  
> — Some wise scientist (probably)

My favorite biology topic right now: **Photosynthesis**  
Equation: 6CO₂ + 6H₂O + light → C₆H₁₂O₆ + 6O₂

Questions I still have:
1. How do mitochondria "talk" to the nucleus?
2. Why do some cells have chloroplasts and others don't?
